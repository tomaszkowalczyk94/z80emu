...
public class LoadDataAndDecrementAndRepeatTest {
    private Z80 z80;
    ...
    public void execute() throws Exception {
        ...
        z80.getMem().write(1, XBit8.valueOfUnsigned(0xB8)); // LDDR
        ...
        Assert.assertEquals(0xAFFF, z80.getRegs().getDE().getUnsignedValue());
        Assert.assertEquals(0x9FFF, z80.getRegs().getHL().getUnsignedValue());
    ...
    @Test
    public void executeWithStopExecuting() throws Exception {
        z80.getMem().write(0, XBit8.valueOfUnsigned(0xED));
        z80.getMem().write(1, XBit8.valueOfUnsigned(0xB8)); // LDDR
