...
public class LoadIxFrom16bitTest {
    private Z80 z80;
    ...
    public void execute() throws Exception {
        ...
        z80.getMemory().write(3, XBit8.valueOfUnsigned(0xF0)); // ld IX, 61500

        z80.runOneInstruction();

        Assert.assertEquals(61500, z80.getRegs().getIx().getUnsignedValue());
