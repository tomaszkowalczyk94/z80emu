...
public class CompareAndDecrementAndRepeatTest {
    private Z80 z80;
    ...
    public void executeAndRepeat() throws Exception {
        ...
        z80.getMem().write(1, XBit8.valueOfUnsigned(0xB9));// CPDR
        ...
        Assert.assertEquals(0x000F, z80.getRegs().getHL().getUnsignedValue());
