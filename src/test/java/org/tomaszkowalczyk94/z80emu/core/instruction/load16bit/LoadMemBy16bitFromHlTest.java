...
public class LoadMemBy16bitFromHlTest {
    private Z80 z80;
    ...
    public void execute() throws Exception {
        z80.getMemory().write(0, XBit8.valueOfUnsigned(0x22));
        z80.getMemory().write(1, XBit8.valueOfUnsigned(0x00));
        z80.getMemory().write(2, XBit8.valueOfUnsigned(0x02)); // ld (200h), HL

        z80.getRegs().setHL(XBit16.valueOfUnsigned(0x1ABF));
