...
public class ExchangeIyWithStackTopTest {
    private Z80 z80;
    ...
    public void execute() throws Exception {
        ...
        z80.getMem().write(1, XBit8.valueOfUnsigned(0xE3)); // EX (SP), IY
        ...
        Assert.assertEquals(0x2211, z80.getRegs().getIy().getUnsignedValue());
