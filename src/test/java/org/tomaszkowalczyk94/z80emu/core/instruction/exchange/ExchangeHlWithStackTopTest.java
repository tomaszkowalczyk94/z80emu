...
public class ExchangeHlWithStackTopTest {
    private Z80 z80;
    ...
    public void execute() throws Exception {
        z80.getMem().write(0, XBit8.valueOfUnsigned(0xE3)); // EX (SP), Hl
        ...
        Assert.assertEquals(0x2211, z80.getRegs().getHL().getUnsignedValue());
